...
- [X] T154 [P] [US5] Add async-opcua inventory validation test for required repository areas in tests/unit/test_async_opcua_inventory.c (OPC refs: N/A - external compliance-suite inventory only)
