...
void test_uasc_finalize_symmetric(void) {
    ...
    size_t total = 0;
    TEST_ASSERT_EQUAL(MU_STATUS_GOOD, mu_uasc_finalize_symmetric(buf, sizeof(buf),
                                                                 /*channel*/ 1, /*token*/ 2,
                                                                 /*seq*/ 3, /*reqId*/ 4,
                                                                 /*body_length*/ 4, &total));
...
void test_uasc_finalize_asymmetric_none(void) {
    ...
    size_t total = 0;
    TEST_ASSERT_EQUAL(MU_STATUS_GOOD, mu_uasc_finalize_asymmetric_none(buf, sizeof(buf),
