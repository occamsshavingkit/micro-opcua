...
void test_policy_none_recognized(void) {
    TEST_ASSERT_EQUAL(MU_SECURITY_POLICY_NONE_ID, from_uri("http://opcfoundation.org/UA/SecurityPolicy#None"));
}
...
void test_unknown_policy_rejected(void) {
    ...
    TEST_ASSERT_EQUAL(MU_SECURITY_POLICY_INVALID_ID, from_uri("http://opcfoundation.org/UA/SecurityPolicy#Non"));
}
...
int main(void) {
    ...
    RUN_TEST(test_policy_aes256_sha256_rsapss_recognized);
