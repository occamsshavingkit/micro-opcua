...
|-------------|---------|-------------|-------|
| 3 | 5.2.1 | Base NodeClass | `include/muc_opcua/address_space.h`, `src/address_space/address_space.c` |
| 3 | 5.5.1 | Object NodeClass | `include/muc_opcua/address_space.h`, `src/address_space/address_space.c` |
| 3 | 5.6.2 | Variable NodeClass | `include/muc_opcua/address_space.h`, `src/address_space/value_source.c` |
| 3 | 5.9 | NodeClass Attributes | `include/muc_opcua/address_space.h`, `src/address_space/value_source.c` |
...
| 4 | 7.38.2 | Common StatusCodes | `include/muc_opcua/status.h`, `src/core/status.c`, `src/encoding/uadp_encoder.c`, `docs/conformance/status.md`, `tests/unit/test_conformance_docs.c`, `tests/unit/test_traceability_docs.c`, `docs/traceability/023-conformance-docs-subscriber.md` |
...
| 6 | 5.2.2.16 | Variant Encoding | `src/encoding/binary_variant.c`, `include/muc_opcua/pubsub.h`, `src/encoding/uadp_encoder.c`, `tests/unit/test_uadp_encoding.c`, `tests/unit/test_traceability_docs.c`, `docs/traceability/023-conformance-docs-subscriber.md` |
...
| 7 | 4.8 | Applications | |
| 14 | 5.4.2.1 | PubSub Publisher component | `include/muc_opcua/pubsub.h`, `src/core/pubsub.c`, `docs/integration-guide.md` |
| 14 | 5.4.2.2 | PubSub Subscriber component | `include/muc_opcua/pubsub.h`, `src/encoding/uadp_encoder.c`, `tests/unit/test_uadp_encoding.c` |
| 14 | 5.4.6.2.2 | UADP WriterGroup message mapping | `src/core/pubsub.c`, `src/encoding/uadp_encoder.c`, `tests/unit/test_pubsub.c` |
| 14 | 7.2.4.4.2 | UADP NetworkMessage layout | `include/muc_opcua/pubsub.h`, `src/encoding/uadp_encoder.c`, `tests/unit/test_uadp_encoding.c`, `tests/unit/test_traceability_docs.c`, `docs/traceability/023-conformance-docs-subscriber.md` |
| 14 | 7.2.4.5.2 | UADP PayloadHeader | `include/muc_opcua/pubsub.h`, `src/encoding/uadp_encoder.c`, `tests/unit/test_uadp_encoding.c`, `tests/unit/test_traceability_docs.c`, `docs/traceability/023-conformance-docs-subscriber.md` |
...
| 14 | 7.2.4.5.5 | Data Key Frame DataSetMessage | `include/muc_opcua/pubsub.h`, `src/encoding/uadp_encoder.c`, `tests/unit/test_uadp_encoding.c`, `tests/unit/test_traceability_docs.c`, `docs/traceability/023-conformance-docs-subscriber.md` |
...
| 14 | 7.3.2.1 | UDP/UADP mapping | `include/muc_opcua/pubsub.h`, `src/core/pubsub.c`, `src/platform/host_udp_adapter.c`, `docs/integration-guide.md` |
